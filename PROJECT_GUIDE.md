...
**Jsi nový agent? Vítej! Následuj tento proces:**

### **📍 KROK 1: Identifikuj TYP úkolu podle klíčových slov**

Přečti svůj úkol od uživatele a najdi klíčová slova. Pak otevři příslušnou Study Guide:

---

**🎨 UI COMPONENTS** (Interaktivní prvky)

Klíčová slova: `button`, `tlačítko`, `input`, `form`, `formulář`, `checkbox`, `radio`, `switch`, `toggle`, `slider`, `dropdown`, `select`, `textarea`, `datepicker`, `timepicker`

→ **Study Guide:** [docs/development/agent-tests/components/UI_COMPONENTS.md](docs/development/agent-tests/components/UI_COMPONENTS.md)  
...
Klíčová slova: `card`, `karta`, `modal`, `dialog`, `popup`, `overlay`, `drawer`, `sidebar`, `nav`, `header`, `footer`, `container`, `grid`, `layout`, `panel`, `accordion`, `tabs`, `záložky`

→ **Study Guide:** [docs/development/agent-tests/components/LAYOUT_COMPONENTS.md](docs/development/agent-tests/components/LAYOUT_COMPONENTS.md)

---

**📊 DATA DISPLAY** (Zobrazení dat)

Klíčová slova: `table`, `tabulka`, `list`, `seznam`, `grid`, `chart`, `graf`, `progress`, `pokrok`, `badge`, `tag`, `tooltip`, `avatar`, `icon`, `ikona`, `stats`, `statistiky`

→ **Study Guide:** [docs/development/agent-tests/components/DATA_DISPLAY.md](docs/development/agent-tests/components/DATA_DISPLAY.md)

---

**🎵 MEDIA COMPONENTS** (Audio/Video)

Klíčová slova: `audio`, `přehrávač`, `player`, `video`, `image`, `obrázek`, `gallery`, `galerie`, `slider`, `carousel`, `waveform`, `vlnový tvar`, `visualizer`

→ **Study Guide:** [docs/development/agent-tests/components/MEDIA_COMPONENTS.md](docs/development/agent-tests/components/MEDIA_COMPONENTS.md)

---

**🎯 ANIMATIONS & EFFECTS** (Animace)

Klíčová slova: `animace`, `animation`, `transition`, `přechod`, `hover`, `loading`, `spinner`, `skeleton`, `fade`, `slide`, `bounce`, `spring`, `pružina`

→ **Study Guide:** [docs/development/agent-tests/components/ANIMATIONS.md](docs/development/agent-tests/components/ANIMATIONS.md)

---

**📱 NAVIGATION** (Navigace)

Klíčová slova: `navigation`, `navigace`, `menu`, `breadcrumb`, `pagination`, `stránkování`, `stepper`, `krokovač`, `tabs`, `bottombar`, `topbar`

→ **Study Guide:** [docs/development/agent-tests/components/NAVIGATION.md](docs/development/agent-tests/components/NAVIGATION.md)

---

**🔔 FEEDBACK** (Zpětná vazba)

Klíčová slova: `notification`, `notifikace`, `toast`, `alert`, `snackbar`, `message`, `zpráva`, `error`, `chyba`, `success`, `úspěch`, `warning`, `varování`

→ **Study Guide:** [docs/development/agent-tests/components/FEEDBACK.md](docs/development/agent-tests/components/FEEDBACK.md)

---

**🎨 TYPOGRAPHY & TEXT** (Text)

Klíčová slova: `heading`, `nadpis`, `text`, `paragraph`, `odstavec`, `label`, `link`, `odkaz`, `code`, `blockquote`, `citace`

→ **Study Guide:** [docs/development/agent-tests/components/TYPOGRAPHY.md](docs/development/agent-tests/components/TYPOGRAPHY.md)

---

**📦 MODULE** (Celý modul)

Klíčová slova: `module`, `modul`, `studio`, `challenges`, `akademie`, `game`, `product`, `produkt`, `standalone`

→ **Study Guide:** [docs/development/agent-tests/03_MODULE_CREATION.md](docs/development/agent-tests/03_MODULE_CREATION.md)

---

**✨ FEATURE** (Nová funkce/stránka)

Klíčová slova: `login`, `register`, `dashboard`, `profile`, `settings`, `page`, `stránka`, `feature`, `funkce`, `authentication`, `auth`

→ **Study Guide:** [docs/development/agent-tests/02_FEATURE_IMPLEMENTATION.md](docs/development/agent-tests/02_FEATURE_IMPLEMENTATION.md)

---

**🐛 BUG FIX** (Oprava)

Klíčová slova: `bug`, `fix`, `oprava`, `chyba`, `error`, `broken`, `nefunguje`, `refactor`, `optimization`, `performance`

→ **Study Guide:** [docs/development/agent-tests/05_BUG_FIX_REFACTOR.md](docs/development/agent-tests/05_BUG_FIX_REFACTOR.md)

---

**❓ NEJSEM SI JISTÝ**

Pokud nenajdeš své klíčové slovo nebo je to tvá první zkušenost s projektem:

→ **Study Guide:** [docs/development/agent-tests/01_GENERAL_ONBOARDING.md](docs/development/agent-tests/01_GENERAL_ONBOARDING.md)

---

### **📍 KROK 2: Prostuduj Study Guide**

1. Otevři příslušnou Study Guide (link výše)
2. Přečti "CO SI NASTUDOVAT"
3. Najdi a přečti relevantní dokumentaci
4. Pochop koncepty a patterns

### **📍 KROK 3: Dej zpětnou vazbu**

**PŘED implementací napiš uživateli:**

```
📚 CO JSEM NASTUDOVAL:
- [seznam dokumentů, které jsi četl]

🎯 MŮJ NÁVRH:
- [tvůj pohled na implementaci]
- [co použiješ - design tokens, patterns]
- [jak to bude vyhovovat 4 temperamentům]
...
### **📍 KROK 4: Čekej na schválení**

**⚠️ NEIMPLEMENTUJ, dokud uživatel nepotvrdí plán!**

### **📍 KROK 5: Implementuj**

Až uživatel schválí tvůj plán → můžeš začít implementovat.

---

### **🔄 "REFRESH MODE" (Pro zkušené agenty)**
...
**TY:**
- Projdeš znovu decision tree
- Přečteš příslušnou Study Guide
- Dáš fresh návrh (nový pohled!)
- Čekáš na schválení

**Fresh perspective = lepší řešení!** ✨
...
```
❌ NIKDY nezačínej implementovat před Study Guide!
❌ NIKDY nepushuj na main bez dotazu!
❌ NIKDY neimplementuj bez schválení plánu!

✅ VŽDY se ujisti, že rozumíš projektu
✅ VŽDY dodržuj 4 temperamenty design
✅ VŽDY dej zpětnou vazbu PŘED implementací
✅ VŽDY čekej na schválení uživatele
```
