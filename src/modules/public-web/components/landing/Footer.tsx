      ...
      <div className="landing-footer__container">
          ...
          <div className="landing-footer__grid">
            ...
            <div className="landing-footer__column">
              ...
              <ul className="landing-footer__links">
                ...
                <li><a href="https://youtube.com/@dechbar" target="_blank" rel="noopener noreferrer">YouTube</a></li>
              </ul>
            </div>
        ...
        <div className="landing-footer__bottom">
          ...
          <div className="landing-footer__social">
            <a href="https://instagram.com/dechbar" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="Instagram">
            ...
            <a href="https://youtube.com/@dechbar" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="YouTube">
              <svg viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="https://facebook.com/dechbar" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="Facebook">
              <svg viewBox="0 0 24 24" fill="currentColor">
